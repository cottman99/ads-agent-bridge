...
[Linux 安装器](https://github.com/cottman99/ads-agent-bridge/releases/download/v0.1.0a43/install.sh)
或 [Windows PowerShell 安装器](https://github.com/cottman99/ads-agent-bridge/releases/download/v0.1.0a43/install.ps1)。
